        ...
        <div class="container">
            ...
            <div class="row">
                <div class="display-header d-flex justify-content-between pb-3">
                    ...
                    <div class="btn-right">
                        <a href="{{ route('user.product.index') }}" class="btn btn-medium btn-normal text-uppercase">Go to
                            Shop</a>
                    </div>
                </div>
                                    ...
                                    <div class="product-card position-relative">
                                        ...
                                        <div class="cart-concern position-absolute">
                                            <div class="cart-button d-flex">
                                                ...
                                                {{-- <a href="{{ route('cart.store',$product->id) }}" class="btn btn-medium btn-black">Add to Cart<svg
                                                    class="cart-outline">
                                                    <use xlink:href="#cart-outline"></use>
                                                </svg></a> --}}
                                            </div>
                                        ...
                                        <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                                            ...
                                            <span class="item-price text-primary"><x-price-after-discount price="{{ $product->price }}"

...
<link href="{{URL::asset('admin-asset/assets/plugins/jquery-nice-select/css/nice-select.css')}}" rel="stylesheet"/>
								...
								<div class="row row-sm ">
									<div class=" col-xl-5 col-lg-12 col-md-12">
										<div class="preview-pic tab-content">
										  <div class="tab-pane active" id="pic-1"><img src="{{URL::asset('admin-asset/assets/img/ecommerce/shirt-5.png')}}" alt="image"/></div>
				...
				<div class="row">
						...
						<div class="card item-card">
							<div class="card-body pb-0 h-100">
								<div class="text-center">
									<img src="{{URL::asset('admin-asset/assets/img/ecommerce/01.jpg')}}" alt="img" class="img-fluid">
								</div>
					...
					<div class="col-lg-3">
						<div class="card item-card">
							<div class="card-body pb-0 h-100">
								<div class="text-center">
									<img src="{{URL::asset('admin-asset/assets/img/ecommerce/04.jpg')}}" alt="img" class="img-fluid">
								</div>
								<div class="card-body cardbody relative">
									<div class="cardtitle">
										<span>Fashion</span>
					...
					<div class="col-lg-3">
						<div class="card item-card">
							<div class="card-body pb-0 h-100">
								<div class="text-center">
									<img src="{{URL::asset('admin-asset/assets/img/ecommerce/07.jpg')}}" alt="img" class="img-fluid">
								</div>
								<div class="card-body cardbody relative ">
									<div class="cardtitle">
					...
					<div class="col-lg-3">
						<div class="card item-card">
							<div class="card-body pb-0 h-100">
								<div class="text-center">
									<img src="{{URL::asset('admin-asset/assets/img/ecommerce/08.jpg')}}" alt="img" class="img-fluid">
								</div>
								<div class="card-body cardbody relative">
									<div class="cardtitle">
										<span>Accessories</span>
...
<script src="{{URL::asset('admin-asset/assets/js/select2.js')}}"></script>
<!-- Internal Nice-select js-->
<script src="{{URL::asset('admin-asset/assets/plugins/jquery-nice-select/js/jquery.nice-select.js')}}"></script>
<script src="{{URL::asset('admin-asset/assets/plugins/jquery-nice-select/js/nice-select.js')}}"></script>
@endsection

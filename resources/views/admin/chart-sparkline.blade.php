...
@section('css')
<!-- Internal Morris Css-->
<link href="{{URL::asset('admin-asset/assets/plugins/morris.js/morris.css')}}" rel="stylesheet">
@endsection
@section('page-header')
				<!-- breadcrumb -->
...
<script src="{{URL::asset('admin-asset/assets/js/chart.sparkline.js')}}"></script>
@endsection

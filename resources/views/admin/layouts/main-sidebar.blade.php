            ...
            @auth('admin')
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('admin.category.index') }}">
                        ...
                        <span class="side-menu__label">{{ __('website/admin.Category') }}</span></a>
                </li>
            @endauth
            <li class="slide">
                <a class="side-menu__item" href="{{ route('admin.product.index') }}">
                    ...
                    <span class="side-menu__label">{{ __('website/admin.Product') }}</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('admin.product-requests.index') }}">
                    ...
                    <i class="fa-brands fa-product-hunt"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span class="side-menu__label">{{ __('website/admin.Product-request') }}</span></a>
            </li>
            <li class="side-item side-item-category">{{ __('website/admin.Contact') }}</li>

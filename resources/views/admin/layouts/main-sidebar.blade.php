...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ route('admin.index') }}"><img
                src="{{ URL::asset('admin-asset/assets/img/brand/logo.png') }}" class="main-logo" alt="logo"></a>
        <a class="desktop-logo logo-dark active" href="{{ route('admin.index') }}"><img
                src="{{ URL::asset('admin-asset/assets/img/brand/logo-white.png') }}" class="main-logo dark-theme"
                alt="logo"></a>
        <a class="logo-icon mobile-logo icon-light active" href="{{ route('admin.index') }}"><img
                src="{{ URL::asset('admin-asset/assets/img/brand/favicon.png') }}" class="logo-icon" alt="logo"></a>
        <a class="logo-icon mobile-logo icon-dark active" href="{{ route('admin.index') }}">
            <img
                src="{{ URL::asset('admin-asset/assets/img/brand/favicon-white.png') }}" class="logo-icon dark-theme"
                alt="logo"></a>
    </div>
    <div class="main-sidemenu">
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('admin-asset/assets/img/avatarr.png') }}">
                        <span
                        class="avatar-status profile-status bg-green"></span>
                </div>
                <div class="user-info">
                    @auth('seller')
                        <h4 class="font-weight-semibold mt-3 mb-0">{{ auth('seller')->user()->name }}</h4>
                    @endauth
                    @auth('admin')
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">{{ __('website/admin.Main') }}</li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('admin.index') }}"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    </svg><span class="side-menu__label">{{ __('website/admin.Index') }}</span></a>
            </li>
            <li class="side-item side-item-category">{{ __('website/admin.General') }}</li>
            {{-- <li class="slide">
            ...
            @auth('admin')
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('admin.category.index') }}">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon icon icon-tabler icon-tabler-menu"
                        ...
                        <span class="side-menu__label">{{ __('website/admin.Categories') }}</span></a>
                </li>
            @endauth
            <li class="slide">
                <a class="side-menu__item" href="{{ route('admin.product.index') }}">
                    ...
                    <span class="side-menu__label">{{ __('website/admin.Products') }}</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('admin.product-requests.index') }}">
                    ...
                    <i class="fa-brands fa-product-hunt"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span class="side-menu__label">{{ __('website/admin.products-requests') }}</span></a>
            </li>
            <li class="side-item side-item-category">{{ __('website/admin.Contacts') }}</li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('admin.contact.index') }}">
                    ...
                    <span class=" side-menu__label">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{ __('website/admin.Contacts') }}
                    </span></a>
            </li>
            <li class="side-item side-item-category">{{ __('website/admin.Orders') }}</li>

            <li class="slide">
                <a class="side-menu__item" href="{{ route('admin.order.index') }}">
                    <i class="fa-solid fa-arrow-down-up-across-line"></i>                    <span class=" side-menu__label">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{ __('website/admin.Orders') }}
                    </span></a>
            </li>
            @auth('admin')

            <li class="side-item side-item-category">{{ __('website/admin.sellers') }}</li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('admin.seller.index') }}">
                    ...
                    <span class=" side-menu__label">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{ __('website/admin.sellers') }}
                    </span></a>
                <a class="side-menu__item" href="{{ route('admin.seller-request.index') }}">
                    {{-- <i class="si si-menu "></i> --}}
                    <i class="si si-people"></i>
                    <span class=" side-menu__label">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{ __('website/admin.seller-request') }}
                    </span></a>
            </li>
            <li class="side-item side-item-category">{{ __('website/admin.users') }}</li>
            ...
            {{-- <li class="slide">
                        <a class="side-menu__item" href="{{ url('/icons') }}">
            ...
            {{-- <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">category</a></li>

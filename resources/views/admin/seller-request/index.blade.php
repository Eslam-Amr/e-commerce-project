                                    ...
                                    <tr>
                                        ...
                                        {{-- <td>
                                            <div style="display: flex;">
                                                @if ($users[$i]->block)
                                                <form id="unblock"
                                                    action="{{ route('admin.user.unblock', $users[$i]) }}" method="POST">
                                                    @method('put')
                                                    @csrf
                                                    <a class="btn btn-danger"
                                                ...
                                                @else
                                                    <form id="block"
                                                        action="{{ route('admin.user.block', $users[$i]) }}" method="POST">
                                                        @method('put')
                                                        @csrf
                                                        <a class="btn btn-danger"
                                                ...
                                                @endif
                                                <form style="margin-left: 20px;" id="destroy"
                                                    action="{{ route('admin.user.destroy', $users[$i]) }}" method="POST">
                                                    @method('delete')
                                                    @csrf
                                                    <a class="btn btn-danger"
                                        ...
                                        {{-- <td>
                                            ...
                                            @auth('seller')
                                                <form action="{{ route('admin.order.update', $orders[$i]) }}" method="POST">
                                                    ...
                                                    <select name="status" class="form-control-color"
                                                        id="status{{ $orders[$i]->id }}" onchange="submitForm(this)">
                                                        <option value="Pending"
                                                            {{ $orders[$i]->status == 'Pending' ? 'selected' : '' }}>Pending
                                                        </option>
                                                        <option value="Processing"
                                                            {{ $orders[$i]->status == 'Processing' ? 'selected' : '' }}>Processing
                                                        </option>
                                                        <option value="On Hold"
                                                            {{ $orders[$i]->status == 'On Hold' ? 'selected' : '' }}>On Hold
                                                        </option>
                                                        <option value="Completed"
                                                            {{ $orders[$i]->status == 'Completed' ? 'selected' : '' }}>Completed
                                                        </option>
                                                        <option value="Cancelled"
                                                            {{ $orders[$i]->status == 'Cancelled' ? 'selected' : '' }}>Cancelled
                                                        </option>
                                                        <option value="Refunded"
                                                            {{ $orders[$i]->status == 'Refunded' ? 'selected' : '' }}>Refunded
                                                        </option>
                                                        <option value="Failed"
                                                            {{ $orders[$i]->status == 'Failed' ? 'selected' : '' }}>Failed</option>
                                                        <option value="Shipped"
                                                            {{ $orders[$i]->status == 'Shipped' ? 'selected' : '' }}>Shipped
                                                        </option>
                                                        <option value="Out for Delivery"
                                                            {{ $orders[$i]->status == 'Out for Delivery' ? 'selected' : '' }}>Out
                                                            for Delivery</option>
                                                        <option value="Delivered"
                                                            {{ $orders[$i]->status == 'Delivered' ? 'selected' : '' }}>Delivered
                                                        </option>
                                                        <option value="Returned"
                                                            {{ $orders[$i]->status == 'Returned' ? 'selected' : '' }}>Returned
                                                        </option>
                                                        <option value="Partially"
                                                            {{ $orders[$i]->status == 'Partially' ? 'selected' : '' }}>Partially
                                                        </option>
                                                    </select>
                                                </form>
